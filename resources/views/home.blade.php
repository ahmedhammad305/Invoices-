						...
						<div class="card overflow-hidden sales-card bg-primary-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h2 class="tx-20 font-weight-bold mb-1 text-white"> {{$invices}}
                                                                                         </h2>
											<h2 class="mb-0 tx-12 text-white op-7">{{$count}}</h2>
										</div>
						...
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{$invices_unpaid}}</h4>
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7"> {{$invices_unpaidPrec}}%
                                            </span>
										</span>
									</div>
								</div>
						...
						<div class="card overflow-hidden sales-card bg-success-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{$invices_unpaid2}}</h4>
											<p class="mb-0 tx-12 text-white op-7">{{$invices_count1}}   </p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7"> {{$invices_unpaidPrec1}}%</span>
										</span>
									</div>
								</div>
							</div>
						...
						<div class="card overflow-hidden sales-card bg-warning-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{$invices_unpaid3}}</h4>
											<p class="mb-0 tx-12 text-white op-7">{{$invices_count3}}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">{{$invices_unpaidPrec2}}%</span>
										</span>
									</div>
								</div>
							</div>
