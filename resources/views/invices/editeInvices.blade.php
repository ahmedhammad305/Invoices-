...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('update_invices',$invoice->id)}}" method ="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="invoice_Date" placeholder="YYYY-MM-DD" value="{{$invoice->Due_date}}"
                                    type="text" required>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select  name="Section" class="form-control SlectBox" onclick="console.log($(this).val())" readonly>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control"  value="{{ $invoice->Value_VAT }}" readonly id="Value_VAT" name="Value_VAT" readonly>
                            </div>
                            <div class="col">
