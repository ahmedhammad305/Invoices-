			...
			<div class="main-sidemenu">
                ...
                @can('الفواتير')
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='invices') }}">قائمه الفواتير</a></li>
							<li><a class="slide-item" href="{{route('Invoice_Paid') }}"> الفواتير المدفوعه</a></li>
							<li><a class="slide-item" href="{{ route('invices_Unpaid') }}"> الفواتير غير المدفوعه</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('Report_Invoices') }}">تقارير الفواتير</a></li>
							<li><a class="slide-item" href="{{ route('Custumer_Report') }}">تقارير العملاء</a></li>
						</ul>
					</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('Users') }}">قائمه المستخدمين</a></li>
                            @can('عرض صلاحية')
							<li><a class="slide-item" href="{{ route('role') }}">صلاحيات المستخدمين</a></li>
                            @endcan
						</ul>
					</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{route('section.com')}}"> الاقسام</a></li>
